...
const SERVICES_DATA = [
    {
        ...
        text:
            'I develop mobile apps in both Android and IOS according to your requirements.',
    },
    {
        icon: icon2,
        title: 'Web Solutions',
        text:
            'I develop scalable and reliable web apps using the latest technologies',
    },
    {
        icon: icon3,
        title: 'Cloud Solutions',
        text:
            'I use cloud solutions to provide efficient and cost-effective services.',
    },
    {
        icon: icon4,
        title: 'AI Solutions',
        text:
            'I use AI solutions to develop decision support systems.',
    },
];
